...
function addDataToSheet() {
  ...
  switch (tabRoom) {
    case "ม.5/6":
      {
        url =
          "https://api.sheety.co/2fb80a9f78e03a86a9c645b99d92db92/score662/six";
        var body = {
          six: {
            date: myDate,
            time: timeTest,
    ...
    case "ม.5/7":
      {
        url =
          "https://api.sheety.co/2fb80a9f78e03a86a9c645b99d92db92/score662/seven";
        var body = {
          seven: {
            date: myDate,
            time: timeTest,
    ...
    default:
      url =
        "https://api.sheety.co/2fb80a9f78e03a86a9c645b99d92db92/score662/data";
      var body = {
        datum: {
          date: myDate,
          time: timeTest,
